...
{
    public partial class Deposit_report_form : Form
    {
        ...
        {
            sqlstr = "select tranNo, tranDate, AcNo, depAmt,detalis,Rem1 from TranTable where depAmt > 0 order by tranNo";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString(" Deposit Informetions", font3, Brushes.Black, xPos, yPos);
            ...
            xPos += 100;
            e.Graphics.DrawString("Dep Amount", font2, Brushes.Black, xPos, yPos);
